local fn = vim.fn
-- Lembrar a última posição do cursor
-- adaptado do https://github.com/ethanholz/nvim-lastplace/blob/main/lua/nvim-lastplace/init.lua

local ignore_buftype = { 'quickfix', 'nofile', 'help', 'terminal' }
local ignore_filetype = { 'gitcommit', 'gitrebase', 'svn', 'hgcommit' }

utils.api.augroup('LastPlace', {
