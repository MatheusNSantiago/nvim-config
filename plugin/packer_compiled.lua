...
_G.packer_plugins = {
  ...
  ["jellybeans.vim"] = {
    loaded = true,
    path = "/home/matheus/.local/share/nvim/site/pack/packer/start/jellybeans.vim",
  ...
  ["lsp-inlayhints.nvim"] = {
    loaded = true,
    path = "/home/matheus/.local/share/nvim/site/pack/packer/start/lsp-inlayhints.nvim",
  ...
  ["toggleterm.nvim"] = {
    loaded = true,
    path = "/home/matheus/.local/share/nvim/site/pack/packer/start/toggleterm.nvim",
  ...
  ["vim-easymotion"] = {
    loaded = true,
    path = "/home/matheus/.local/share/nvim/site/pack/packer/start/vim-easymotion",
