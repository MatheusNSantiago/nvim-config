...
function M.setup()
	...
	if is_installed then
		...
		keymap({'n', 't'}, '<C-l>', smart_splits.move_cursor_up, { desc = 'smart-splits: move cursor up' })
		keymap({'n', 't'}, '<C-k>', smart_splits.move_cursor_down, { desc = 'smart-splits: move cursor down' })
		keymap({'n', 't'}, '<C-j>', smart_splits.move_cursor_left, { desc = 'smart-splits: move cursor left' })
		keymap({'n', 't'}, '<C-w>l', smart_splits.move_cursor_right, { desc = 'smart-splits: move cursor right' }) -- (auto key = <C-ç>)
