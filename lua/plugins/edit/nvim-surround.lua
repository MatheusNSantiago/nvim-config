...
function M.config()
  require('nvim-surround').setup({
    ...
    surrounds = {
      ['('] = {
        add = { '( ', ' )' },
        find = function() return M.get_selection({ motion = 'a(' }) end,
        delete = '^(. ?)().-( ?.)()$',
      },
      [')'] = {
        add = { '(', ')' },
      ...
      ['i'] = { -- TODO: Add find/delete/change functions
        add = function()
          ...
          if right_delimiter then return { { left_delimiter }, { right_delimiter } } end
        end,
        find = function() end,
        delete = function() end,
      },
      ['t'] = {
        ...
        find = function() return M.get_selection({ motion = 'at' }) end,
        delete = '^(%b<>)().-(%b<>)()$',
        change = {
          target = '^<([^%s<>]*)().-([^/]*)()>$',
      ...
      invalid_key_behavior = {
        add = function(char)
          if not char or char:find('%c') then return nil end
          return { { char }, { char } }
        end,
        find = function(char)
          if not char or char:find('%c') then return nil end
