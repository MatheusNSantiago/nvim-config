...
function M.setup_facade_keymaps(state)
  ...
  local function start_in_place_insert(mode)
    ...
    if cell_idx then
      ...
      if content_start and content_end and (cursor_line < content_start or cursor_line > content_end) then
  ...
  if config.float and config.float.edit_in_place then
    vim.keymap.set('n', '<CR>', function()
      start_in_place_insert('i')
    end, vim.tbl_extend('force', opts, { desc = 'Edit cell in place' }))
    ...
    vim.keymap.set('n', 'A', function()
      start_in_place_insert('A')
    end, vim.tbl_extend('force', opts, { desc = 'Edit cell in place at line end' }))

    vim.keymap.set('n', 'o', function()
      start_in_place_insert('o')
    end, vim.tbl_extend('force', opts, { desc = 'Edit cell in place open line below' }))

    vim.keymap.set('n', 'O', function()
      start_in_place_insert('O')
    end, vim.tbl_extend('force', opts, { desc = 'Edit cell in place open line above' }))
  else
  ...
  if not (config.float and config.float.edit_in_place) then
