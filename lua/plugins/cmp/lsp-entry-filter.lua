---@class LspTypeLimiterContext
---@field filetype string
---@field kind string
---@field cur_line string

---@param fo? fun(ctx: LspTypeLimiterContext): boolean
---@return fun(entry:cmp.Entry, ctx:cmp.Context): boolean
return function(fo)
	return function(entry, ctx)
		local deu_certo, res = utils.pcall(function()
			...
			if fo then --
				return fo({ filetype = ctx.filetype, kind = kind, cur_line = cur_line })
			end
