...
M.format_tailwind = function(entry, vim_item)
	...
	if vim.tbl_contains({ 'nvim_lsp' }, entry.source.name) then
		...
		if not color_name or not color_number then return vim_item end

		local color_index = tonumber(color_number)
		local tailwindcss_colors = M.TailwindcssColors

		if not tailwindcss_colors[color_name] then return vim_item end

		if not tailwindcss_colors[color_name][color_index] then return vim_item end
