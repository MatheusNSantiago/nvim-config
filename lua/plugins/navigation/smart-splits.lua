...
function M.setup()
	...
	return {
		...
		keys = {
			...
			{
				is_wsl and '<C-S-A-Left>' or '<C-S-A-j>',
				function() require('smart-splits').resize_left() end,
				desc = 'smart-splits: resize left',
			},
			{
				is_wsl and '<C-S-A-Right>' or '<C-S-A-ç>',
			...
			--  │                     Swapping splits                      │
			--  ╰──────────────────────────────────────────────────────────╯
			{ '<leader>J', function() require('smart-splits').swap_buf_left() end, desc = 'smart-splits: swap buffer left' },
			{
				'<leader>Ç',
				function() require('smart-splits').swap_buf_right() end,
				desc = 'smart-splits: swap buffer right',
			},
			{ '<leader>L', function() require('smart-splits').swap_buf_up() end, desc = 'smart-splits: swap buffer up' },
			{ '<leader>K', function() require('smart-splits').swap_buf_down() end, desc = 'smart-splits: swap buffer down' },
		},
	}
end
...
-- 		{ is_wsl and '<C-S-A-Down>' or '<C-S-A-k>', smart_splits.resize_down, desc = 'smart-splits: resize down' },
-- 		{ is_wsl and '<C-S-A-Left>' or '<C-S-A-j>', smart_splits.resize_left, desc = 'smart-splits: resize left' },
-- 		{ is_wsl and '<C-S-A-Right>' or '<C-S-A-ç>', smart_splits.resize_right, desc = 'smart-splits: resize right' },
--
-- 		-- moving between splits
